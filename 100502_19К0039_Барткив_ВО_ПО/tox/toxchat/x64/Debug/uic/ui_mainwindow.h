...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        connectionStatusLabel->setGeometry(QRect(30, 430, 301, 16));
        errorStatusLabel = new QLabel(centralwidget);
        errorStatusLabel->setObjectName("errorStatusLabel");
        errorStatusLabel->setGeometry(QRect(30, 450, 671, 16));
        connectButton = new QPushButton(centralwidget);
        connectButton->setObjectName("connectButton");
        connectButton->setGeometry(QRect(340, 490, 80, 24));
        passwordLineEdit = new QLineEdit(centralwidget);
        passwordLineEdit->setObjectName("passwordLineEdit");
        passwordLineEdit->setGeometry(QRect(30, 540, 241, 24));
        initializeButton = new QPushButton(centralwidget);
        initializeButton->setObjectName("initializeButton");
        initializeButton->setGeometry(QRect(290, 540, 80, 24));
        usernameLineEdit = new QLineEdit(centralwidget);
        usernameLineEdit->setObjectName("usernameLineEdit");
        usernameLineEdit->setGeometry(QRect(30, 510, 241, 24));
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        errorStatusLabel->setText(QCoreApplication::translate("MainWindow", "OK", nullptr));
        connectButton->setText(QCoreApplication::translate("MainWindow", "connect", nullptr));
        initializeButton->setText(QCoreApplication::translate("MainWindow", "Login", nullptr));
        (void)MainWindow;
    } // retranslateUi
